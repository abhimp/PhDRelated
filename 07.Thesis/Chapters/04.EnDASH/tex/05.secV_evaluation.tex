...
\begin{figure}[h]
	...
	\end{center}
	\caption{\label{fig:chap04:energycost}Comparison of energy consumption and energy efficiency between different ABR algorithms and lowest quality video playback.}
\end{figure}
