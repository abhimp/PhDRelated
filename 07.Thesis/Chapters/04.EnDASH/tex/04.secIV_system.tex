...
\indent Second term in the reward function is the \textbf{\ac{QoE}} metric  \cite{MPC-SIGCOMM-2015}:
...
\begin{figure}[ht]
	...
	\end{center}
	\caption{\label{fig:chap04:EnDASH_vs_others}Performance comparison of EnDASH with baseline \ac{ABR} streaming algorithms, BOLA \cite{Spiteri2016}, Pensieve \cite{mao2017neural}, Fast MPC \cite{MPC-SIGCOMM-2015}, Robust MPC \cite{MPC-SIGCOMM-2015}}
\end{figure}
%  \begin{figure*}[t]%
%  	\centering
...
\begin{figure}[ht]
	...
	\end{center}
	\caption{\label{fig:chap04:indi_QoE}Comparison of different components of \ac{QoE} score (average bitrate, stall time, smoothness) of EnDASH with baseline \ac{ABR} streaming algorithms, BOLA \cite{Spiteri2016}, Pensieve \cite{mao2017neural}, Fast MPC \cite{MPC-SIGCOMM-2015}, Robust MPC \cite{MPC-SIGCOMM-2015}}
\end{figure}
%  \begin{figure*}[t]%
%  	\centering
%  	\vspace*{-0.5cm}
