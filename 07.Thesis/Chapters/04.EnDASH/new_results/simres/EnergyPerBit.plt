...
plot \
    'bola/PowerEnv.dat' u (0):($2/(1000 * $5 * $6)) lc rgb word(colors, 1) notitle, \
    for [i=1:words(legends)] word(abrs, i).'/PowerMeasure.dat' u (i):($2/(1000 * $5 * $6)) lc rgb word(colors, i+1) notitle
