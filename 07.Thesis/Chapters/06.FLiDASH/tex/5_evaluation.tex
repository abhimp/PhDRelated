...
\begin{figure}[!ht]
	...
	\begin{center}
		\subfloat[\label{fig:chap06:grp_dl_share}Download share of a Coalition Member: The average download share of individual players meet the theoretical fair share bound ($y=\frac{1}{x}$)]{
      	...
      	\subfloat[\label{fig:chap06:grp_fairness}Jain fairness index on QoE achieved among players: Intra-coalition QoE fairness is always good, inter-coalition fairness depends on coalition size]{
