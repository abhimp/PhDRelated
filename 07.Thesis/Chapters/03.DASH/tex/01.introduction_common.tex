...
In this chapter, we are analysis the video streaming system of YouTube, one of the most popular video streaming service. Although we know that YouTube deploy some variation of the DASH guideline, it we are not sure
