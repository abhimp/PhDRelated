...
\RC{The prediction model depends on provided bandwidth. The Bandwidth can be predicted in advance to understand the possibility of data wastage or it can be measured without playing a video and understand the data wastage without ever playing the video.}
