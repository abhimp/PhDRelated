...
During the video playback, we capture video data packets using the Unix tool \texttt{tcpdump}; from these packet traces, we extract the amount of video data transferred from the YouTube server to the browser, with respect to time.
