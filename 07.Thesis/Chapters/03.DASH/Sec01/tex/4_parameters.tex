...
\begin{table}[!t]
	...
	\begin{tabular}{ | >{\centering\arraybackslash}m{2.8in} |> {\centering\arraybackslash}m{2.8in} | }
		...
		%\multicolumn{2}{| c |}{}  \\ \hline
		%\multicolumn{2}{| c |}{}  \\ \hline
		\multicolumn{2}{| c |}{\textbf{\em Muliple video multiple sessions}}  \\ \hline
