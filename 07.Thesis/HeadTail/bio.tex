...
\begin{enumerate}
\item Nishant Somy, \textbf{Abhijit Mondal}, Bishakh Ghosh, and Sandip Chakraborty, ``\textit{System Call Interception for Serverless Isolation}", in Proceedings of the ACM Conference on Special Interest Group on Data Communication (ACM SIGCOMM '20) -- Demos and Posters, August 10 - 14, 2020.
