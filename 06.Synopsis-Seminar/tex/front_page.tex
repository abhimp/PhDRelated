\title{\fontsize{18}{18} \textbf{Adaptive Bitrate Streaming: Performance over Today's Internet and Optimizations for the Future}}
...
{\centering {\fontsize{14}{14} \textbf{December 2020}}\par}
