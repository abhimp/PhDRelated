...
set ylabel "Bitrate Variation (Mbps)"
...
plot \
    'bola/PowerEnv.dat' u (0):($7/1000000) lc rgb word(colors, 1) notitle, \
    for [i=1:words(legends)] word(abrs, i).'/PowerMeasure.dat' u (i):($7/1000000) lc rgb word(colors, i+1) notitle
