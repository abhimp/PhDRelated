...
\begin{figure}[ht]
	...
	\begin{center}
		\subfloat[\label{fig:avgBitratecmf}Average Bit-rate]{
			\includegraphics[width=0.45\linewidth]{img/grpbasic/avgbitrate_cdf_1}
		}
     	\subfloat[\label{fig:avgBitrateVarcmf}Bit-rate Variation]{
     			\includegraphics[width=0.45\linewidth]{img/grpbasic/avgbitrate_var_cdf_1}
     		}
	\end{center}
...
\begin{figure}[!ht]
	...
	\begin{center}
		\subfloat[\label{fig:Stall_Timecmf}Total Re-buffering Time]{
			\includegraphics[width=0.45\linewidth]{img/grpbasic/stalltime_cdf_1}
		}
       	\subfloat[\label{fig:QoEcmf}Overall QoE]{
       			\includegraphics[width=0.45\linewidth]{img/grpbasic/qoe_cdf_1}
       		}
	\end{center}
...
\begin{figure}[!ht]
	...
	\begin{center}
		\subfloat[\label{fig:cdnuploaded_byte} Data downloaded from server]{
			\includegraphics[width=0.45\linewidth]{img/grpbasic/cdnupload_1}
		}
		\subfloat[\label{fig:cdnuploaded_cnt} Segment downloads from server]{
			\includegraphics[width=0.45\linewidth]{img/grpbasic/cdnuploadcnt_1}
		}
	\end{center}
...
\begin{figure*}[!ht]
	...
	\begin{center}
		\subfloat[\label{fig:grp_qoe}Overall QoE]{
			\includegraphics[width=0.3\linewidth]{img/grpbasic/grpsz_qoe}
		}
		\subfloat[\label{fig:grp_download}Amount of Data Upload and Download]{
			\includegraphics[width=0.3\linewidth]{img/grpbasic/grpsz_upload_download}
		}
		\subfloat[\label{fig:grp_fairness}Fairness]{
			\includegraphics[width=0.3\linewidth]{img/grpbasic/grpsz_fairness}
		}
	\end{center}
