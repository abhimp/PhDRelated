...
plot for [i=1:words(abrs)] 'data/bitrate_'.word(abrs, i).'_http_cdf.dat' u 1:2 w p pt ptypes[i] ps 2 lc rgb "blue" notitle, \
        for [i=1:words(abrs)] 'data/bitrate_'.word(abrs, i).'_quic_cdf.dat' u 1:2 w p pt ptypes[i] ps 2 lc rgb "red" notitle, \
