...
plot for [i=1:words(abrs)] 'data/qoe_'.word(abrs, i).'_http.dat' u (i-0.15):1 lc rgb "blue" notitle, \
        for [i=1:words(abrs)] 'data/qoe_'.word(abrs, i).'_quic.dat' u (i+0.15):1 lc rgb "red" notitle, \
